...
<head>
    ...
    {{HTML::style('template/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css')}}
    {{HTML::style('template/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css')}}
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="{{URL::to('/')}}">
                {{HTML::image('template/img/logoblue.png', 'CRM HELPDESK')}}
            </a>
            <!-- END LOGO -->
                    ...
                    <li class="dropdown" id="header_inbox_bar">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                      <span class="photo">
                                        {{HTML::image('template/img/avatar-mini.png', 'avatar')}}
                                      </span>
									<span class="subject">
            ...
            <div class="top-nav ">
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            {{HTML::image('template/img/avatar1_small.jpg')}}
                            ...
                            <div class="timeline-messages">
                                ...
                                <div class="msg-time-chat">
                                    <a class="message-img" href="#">
                                        {{HTML::image('template/img/avatar1.jpg', 'avatar', array('class'=>'avatar'))}}
                                    </a>
                                ...
                                <div class="msg-time-chat">
                                    <a class="message-img" href="#">
                                        {{HTML::image('template/img/avatar2.jpg', 'avatar', array('class'=>'avatar'))}}
                                    </a>
...
<!-- BEGIN FOOTER -->
<div id="footer">
    2014 &copy; IT Support Kholid Inc.&reg;
</div>
<!-- END FOOTER -->
...
{{HTML::script('template/assets/fullcalendar/fullcalendar/fullcalendar.min.js')}}
...
{{HTML::script('template/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js')}}
{{HTML::script('template/js/jquery.sparkline.js')}}
{{HTML::script('template/assets/chart-master/Chart.js')}}
...
{{HTML::script('template/js/easy-pie-chart.js')}}
{{HTML::script('template/js/sparkline-chart.js')}}
{{HTML::script('template/js/home-page-calender.js')}}
{{HTML::script('template/js/chartjs.js')}}

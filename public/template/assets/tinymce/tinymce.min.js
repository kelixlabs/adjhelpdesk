...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        var x, w, _, N, E, k, S, T, R, A, B, L, D, H, M, P, O, I = "sizzle" + -new Date, F = window.document, z = {}, W = 0, V = 0, U = n(), q = n(), $ = n(), j = !1, K = function () {
            return 0
        }, Y = typeof t, G = 1 << 31, X = [], J = X.pop, Q = X.push, Z = X.push, et = X.slice, tt = X.indexOf || function (e) {
        ...
        function t(n) {
            ...
            function p(e, t) {
                var n = H[V], r = H[W], i = H[U], o = H[q], a = t.startContainer, s = t.startOffset, l = t.endContainer, c = t.endOffset;
            ...
            function A(e, t) {
                var n = C(H[V], H[W]), r = n != H[V], i, o, a, s, l;
            ...
            var H = this, M = n.doc, P = 0, O = 1, I = 2, F = !0, z = !1, W = "startOffset", V = "startContainer", U = "endContainer", q = "endOffset", $ = e.extend, j = n.nodeIndex;
            return $(H, {
                startContainer: M,
                startOffset: 0,
                endContainer: M,
        ...
        return function (i, o) {
            ...
            i = i || {}, a.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var s = this, l, c = 0, u, d, f = [], p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, D, H, M, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href"), V = /(java|vb)script:/i;
                    ...
                    if (c < l.index && s.text(F(e.substr(c, l.index - c))), u = l[6])u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), r(u); else if (u = l[7]) {
                        if (u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), x = u in b, z && D[u] && f.length > 0 && f[f.length - 1].name === u && r(u), !w || (_ = o.getElementRule(u))) {
                            if (N = !0, w && (S = _.attributes, T = _.attributePatterns), (k = l[8]) ? (v = -1 !== k.indexOf("data-mce-type"), v && y && (N = !1), p = [], p.map = {}, k.replace(M, a)) : (p = [], p.map = {}), w && !v) {
                                if (R = _.attributesRequired, A = _.attributesDefault, B = _.attributesForced, L = _.removeEmptyAttrs, L && !p.length && (N = !1), B)for (h = B.length; h--;)E = B[h], g = E.name, O = E.value, "{$uid}" === O && (O = "mce_" + I++), p.map[g] = O, p.push({
                                    name: g,
                                    value: O
                                });
                        ...
                        x || (k && k.indexOf("/") == k.length - 1 ? N && s.end(u) : f.push({name: u, valid: N}))
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                var v, y, b, C, x, w, _, N, E, k, S, T, R, A = [], B, L, D, H, M, P, O, I;
                        ...
                        start: function (e, t, n) {
                            ...
                            if (r = S ? l.getElementRule(t) : {}) {
                                if (T[t] && !B) {
                                    ...
                                    if (n = b.lastChild, n && 3 === n.type)if (i = n.value.replace(L, ""), i.length > 0)n.value = i, n = n.prev; else for (o = n.prev, n.remove(), n = o; n && 3 === n.type;)i = n.value, o = n.prev, (0 === i.length || H.test(i)) && (n.remove(), n = o), n = o
                                }
        ...
        return function (r, i) {
            ...
            function l(e, t, n) {
                ...
                r = b.getPos(e, p), T = r.x, R = r.y, f = e.getBoundingClientRect(), l = f.width || f.right - f.left, u = f.height || f.bottom - f.top, x != e && (m(), x = e, H = M = 0), d = i.fire("ObjectSelected", {target: e}), o(e) && !d.isDefaultPrevented() ? C(_, function (e, r) {
                    function o(t) {
            ...
            function p(e) {
                ...
                for (r in _)if (o = _[r], a = t.offsetWidth * o[0], s = t.offsetHeight * o[1], Math.abs(a - c) < 8 && Math.abs(s - u) < 8) {
                    N = o;
                    break
                }
            ...
            var b = i.dom, C = t.each, x, w, _, N, E, k, S, T, R, A, B, L, D, H, M, P = i.getDoc(), O = document, I = n.ie && n.ie < 11;
            _ = {
                n: [.5, 0, 0, -1],
                e: [1, .5, 1, 0],
                s: [.5, 1, 0, 1],
        ...
        return a.prototype = {
            setCursorLocation: function (e, t) {
                ...
                function t(t) {
                    ...
                    var c, u, d, f = n.dom, p = f.getRoot(), h, m, g, v;
        ...
        return function (r) {
            ...
            function p(t, n, o) {
                ...
                if (m)if (o)o.nodeType ? (y = I.createRng(), y.setStartBefore(o), y.setEndAfter(o), d(T(y, h), null, !0)) : d(o, null, !0); else if (b && m.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length)M("apply", t, n); else {
            ...
            function M(t, n, o) {
                ...
                function d(e, t) {
                    var n, r;
                    if (e)r = F.getRng(!0), s(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), I.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === $ && (n = n.deleteData(0, 1)), I.remove(e, 1)), F.setRng(r); else if (e = l(F.getStart()), !e)for (; e = I.get(y);)d(e, !1)
                }
                ...
                function m() {
                    ...
                    if (d)if (l)s = F.getBookmark(), e.collapse(!0), e = T(e, c(n), !0), e = z.split(e), h(n, o, e), F.moveToBookmark(s); else {
        ...
        return r = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", "<div[^>]+data-mce-bogus[^>]+><\\/div>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function (t) {
            ...
            return t.on("init", function () {
                ...
                data: l, typing: !1, beforeChange: function () {
                    ...
                    if (e = e || {}, e.content = i(), d || t.fire("BeforeAddUndo", {level: e}).isDefaultPrevented())return null;
        ...
        return function (r) {
            function i(i) {
                ...
                function g(e) {
                    var t = T, r, i, a;
                    if (e || "TABLE" == P ? (r = o.create(e || I), m(r)) : r = A.cloneNode(!1), a = r, s.keep_styles !== !1)do if (/^(SPAN|STRONG|B|EM|I|FONT|STRIKE|U)$/.test(t.nodeName)) {
                ...
                function C() {
                    for (var t = new e(T, A), n; n = t.next();)if (u[n.nodeName.toLowerCase()] || n.length > 0)return !0
                }
                ...
                var E = a.getRng(!0), k, S, T, R, A, B, L, D, H, M, P, O, I, F;
                ...
                if (!i.isDefaultPrevented() && (T = E.startContainer, R = E.startOffset, I = (s.force_p_newlines ? "p" : "") || s.forced_root_block, I = I ? I.toUpperCase() : "", B = o.doc.documentMode, L = i.shiftKey, 1 == T.nodeType && T.hasChildNodes() && (F = R > T.childNodes.length - 1, T = T.childNodes[Math.min(R, T.childNodes.length - 1)] || T, R = F && 3 == T.nodeType ? T.nodeValue.length : 0), S = _(T))) {
                    ...
                    I && A === r.getBody() || (I = I || "P", v() ? (D = /^(H[1-6]|PRE|FIGURE)$/.test(P) && "HGROUP" != O ? g(I) : g(), s.end_container_on_empty_block && d(M) && o.isEmpty(A) ? D = o.split(M, A) : o.insertAfter(D, A), h(D)) : v(!0) ? (D = A.parentNode.insertBefore(g(), A), f(D), h(A)) : (k = E.cloneRange(), k.setEndAfter(A), H = k.extractContents(), w(H), D = H.firstChild, o.insertAfter(H, A), p(D), N(A), h(D)), o.setAttrib(D, "id", ""), r.fire("NewBlock", {newBlock: D}), l.add())
                }
            }

            var o = r.dom, a = r.selection, s = r.settings, l = r.undoManager, c = r.schema, u = c.getNonEmptyElements();
        ...
        var i = t.makeMap("focusin focusout scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave wheel keydown keypress keyup contextmenu", " "), o = {}, a = "onmousewheel"in document, s = !1, l = e.extend({
            ...
            initLayoutRect: function () {
                var e = this, t = e.settings, n, i, o = e.getEl(), a, s, l, c, u, d, f, p;
        ...
        return function (t) {
            ...
            function s() {
                var n = r();
                if (!n || "TEXTAREA" != n.nodeName && "text" != n.type)return t.onAction ? t.onAction(m) : e.fire(r(), "click", {keyboard: !0}), !0
            }
            ...
            function u() {
                var e, r;
                for (r = i(t.root.getEl()), n(), e = h.length; e--;)if ("toolbar" == r && h[e].id === m)return h[e].focus(), void 0;
                h[0].focus()
            }
        ...
        return function (a) {
            ...
            var O = o.each, I = e.BACKSPACE, F = e.DELETE, z = a.dom, W = a.selection, V = a.settings, U = a.parser, q = a.serializer, $ = i.gecko, j = i.ie, K = i.webkit;
        ...
        return {
            fire: function (e, i, o) {
                ...
                if (e = e.toLowerCase(), i = i || {}, i.type = e, i.target || (i.target = a), i.preventDefault || (i.preventDefault = function () {
                    ...
                    }, i.isDefaultPrevented = t, i.isPropagationStopped = t, i.isImmediatePropagationStopped = t), a[r] && (s = a[r][e]))for (l = 0, c = s.length; c > l && (s[l] = u = s[l], !i.isImmediatePropagationStopped()); l++)if (u.call(a, i) === !1)return i.preventDefault(), i;
                if (o !== !1 && a.parent)for (d = a.parent(); d && !i.isPropagationStopped();)d.fire(e, i, !1), d = d.parent();
                return i
            }, on: function (e, t) {
                var n = this, o, a, s, l;
                if (t === !1 && (t = function () {
        ...
        var E = e.DOM, k = n.ThemeManager, S = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray, L = C.trim, D = C.resolve, H = h.Event, M = b.gecko, P = b.ie;
        return N.prototype = {
            render: function () {
                function e() {
                ...
                var n = this, o = n.settings, f = E.get(n.id), p = n.getDoc(), h, m;
                o.inline || (n.getElement().style.visibility = n.orgVisibility), t || o.content_editable || (p.open(), p.write(n.iframeHTML), p.close()), o.content_editable && (n.on("remove", function () {
                    ...
                    initial: !0,
                    format: "html"
                }), n.startContent = n.getContent({format: "raw"}), n.initialized = !0, R(n._pendingNativeEvents, function (e) {
                    n.dom.bind(_(n, e), e, function (e) {
                        n.fire(e.type, e)
                    })
                }), n.fire("init"), n.focus(!0), n.nodeChanged({initial: !0}), n.execCallback("init_instance_callback", n), n.contentStyles.length > 0 && (m = "", R(n.contentStyles, function (e) {
                    m += e + "\r\n"
        ...
        return e.extend({
            Defaults: {defaultType: "button", role: "toolbar"}, renderHtml: function () {
                var e = this, t = e._layout;
            ...
            Defaults: {
                ...
                n.each(function (n) {
                    ...
                    i && (r = new t({
                        ...
                        autoResize: "overflow",
                        defaults: {flex: 1},
                        items: [{type: "label", text: i, flex: 0, forId: n._id}]
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v = [], y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, D, H, M, P, O, I, F, z, W, V = Math.max, U = Math.min;
        ...
        function a(e) {
            ...
            function o() {
                ...
                var r = 0, i = [], o = [{
                    title: "Headers",
                    items: [{title: "Header 1", format: "h1"}, {title: "Header 2", format: "h2"}, {
                        title: "Header 3",
                        format: "h3"
                    }, {title: "Header 4", format: "h4"}, {title: "Header 5", format: "h5"}, {
                        title: "Header 6",
                        format: "h6"
                    }]
                }, {
                ...
                return a = {
                    type: "menu", items: a, onPostRender: function (t) {
            ...
            p = o(), s({
                ...
                return s(o, function (e) {
                    n.push({
                        text: e[0], value: e[1], textStyle: function () {
                            return t(e[1])
                        }
                    })
        ...
        return e.extend({
            recalc: function (e) {
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    var D = 0, H = t.flexWidths;
                    if (H)for (d = 0; d < H.length; d++)D += H[d]; else D = r;
                    var M = A / D;
        ...
        var i = e.extend({
            Defaults: {defaultType: "menuitem", border: 1, layout: "stack", role: "menu"},
            init: function (e) {
                var i = this;
        ...
        return e.extend({
            Defaults: {classes: "widget btn splitbtn", role: "splitbutton"}, repaint: function () {
